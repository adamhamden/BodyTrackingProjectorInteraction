...
def plane_finder(point_1, point_2, point_3):
    ...
    try:
        if np.array_equal(vect_1, np.array([0, 0, 0])) or np.array_equal(vect_2, np.array([0, 0, 0])) or np.array_equal(
                vect_3, np.array([0, 0, 0])):
    ...
    try:
        if np.array_equal(pt1_unit, pt2_unit) or np.array_equal(pt1_unit, pt3_unit) or np.array_equal(pt3_unit,
                                                                                                      pt2_unit):
